  ...
  return (
    <header className="sticky top-0 z-30 h-14 border-b border-border bg-background/80 backdrop-blur-md px-6 flex items-center justify-between">
      <div className="flex-1">
        {/* Breadcrumbs or Title could go here later */}
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="w-6 h-6 bg-gradient-to-tr from-zinc-800 to-zinc-600 dark:from-zinc-200 dark:to-zinc-400 rounded-full flex items-center justify-center text-[10px] font-bold text-background shadow-sm">
            T
          </div>
